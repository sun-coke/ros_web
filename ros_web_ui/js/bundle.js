...
class WidgetInstanceEvents extends events_1.EventsParent {
    ...
    ;
    _WidgetSettingsActionServers(widgetInstanceId) {
    ...
    ;
    _WidgetSettingsRefreshActionServers() {
        this.Ros.getActionServers((actionServersResponse) => {
    ...
    ;
    _WidgetSettingsConfirmActionServers(widgetInstanceId) {
        $(".jsRosActionServerSelector").each((index, elem) => {
            let widgetInstance = workspace_1.currentWorkspace.get(widgetInstanceId, "WidgetInstance");
            let actionServerChangeCallback = $(elem).attr("data-ros-actionserver-chng");
            let actionServerSelected = $(elem).val();
...
},{"../model/serialized_workspace":9,"../model/workspace":14,"../super/lightbox":17,"../super/storage":19,"./events":1}],7:[function(require,module,exports){
/// <reference path="./typings/tsd.d.ts" />
"use strict";
// Events
...
function init() {
    $(document).ready(function () {
        $("#jsRosUrl").val("ws://localhost:9090");
...
},{"./events/ros":2,"./events/tab":3,"./events/widget":4,"./events/widget_instance":5,"./events/workspace":6,"./model/workspace":14,"./super/lightbox":17}],8:[function(require,module,exports){
"use strict";
class ROSWeb {
    constructor() {
...
},{"../super/frontend":16,"./workspace":14}],14:[function(require,module,exports){
/// <reference path="../typings/tsd.d.ts" />
"use strict";
// model
...
class Workspace {
    ...
    _initWorkspace() {
        ...
        new widget_1.Widget(wg.id, "Topic Publisher", "TopicPublisher", "./widgets/topic_publisher");
        ...
        new widget_1.Widget(wg.id, "ActionLib Tool", "ActionLibTool", "./widgets/action_lib_tool");
        ...
        new widget_1.Widget(wg.id, "IMU Viewer", "ImuViewer", "./widgets/imu_viewer");
        wg = new widget_group_1.WidgetGroup("3D Viewer");
        new widget_1.Widget(wg.id, "ROS 3D Viewer", "ROS3DViewer", "./widgets/ros_3d_viewer");
        wg = new widget_group_1.WidgetGroup("Diagnostics");
        new widget_1.Widget(wg.id, "Diagnostics Viewer", "DiagnosticsViewer", "./widgets/diagnostics_viewer");
        new widget_1.Widget(wg.id, "Log reader", "LogReader", "./widgets/log_reader");
...
class Frontend {
    ...
    UpdateActionServerSelectors(response) {
        $(".jsRosActionServerSelector").html("");
        var html = '';
        $(".jsRosActionServerSelector").each((i, element) => {
            let elementWidgetInstance = $(".jsWidgetContainer[data-widget-instance-id=" + $(element).attr("data-widget-instance-id") + "]");
            let elementMeta = $(elementWidgetInstance).find("meta[data-ros-actionserver-id='" + $(element).attr("data-ros-actionserver-id") + "']");
            let selectedActionServer = $(elementMeta).attr("data-ros-actionserver-slctd");
            html = MyApp.templates.rosActionServerSelectorOptions({ name: '-- Select an action server to subscribe --', value: "" });
            let strTypes = $(element).attr("data-ros-actionserver-type");
            let types = (strTypes == "") ? [] : strTypes.split("|");
            response.forEach((value, index) => {
                let selected = (value == selectedActionServer) ? true : false;
...
},{"../model/tab":10,"../model/workspace":14,"./names":18,"./trigger":20}],17:[function(require,module,exports){
/// <reference path="../typings/tsd.d.ts" />
"use strict";
class Lightbox {
    constructor() {
